...
export default {
  ...
  methods: {
    ...
    activePrice (price, unit) {
      ...
      var returnPriceHtml = `&#xa5;<span style="font-size: 1.1rem;">${priceArr[0]}</span>.<span style="font-size: 0.9rem;">${priceArr[1]}</span>`
      if (unit) {
      ...
      this.$tip(Vue.extend({
        ...
        methods: {
          ...
          toGet () {
            ...
            this.$loading('洗车券领取中...')
            this.$comfun.http_post(this, 'a=addclearncars', {
...
<style scoped>
  ...
  .datas-wrap > .coupon-wrap > .show-more-wrap::before {
    ...
    width: 90%;
    height: 4rem;
    background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0), rgb(255, 255, 255));
    z-index: 9;
    pointer-events: none;
  }
  ...
  .datas-wrap > .coupon-wrap > .coupon-items-wrap > .coupon-item:nth-of-type(n + 2) {
    margin-top: 0.4rem;
  }
  ...
  .datas-wrap > .coupon-wrap > .coupon-items-wrap > .coupon-item > .info > .info-shopname {
    position: absolute;
  ...
  .datas-wrap > .coupon-wrap > .coupon-items-wrap > .coupon-item > .info > .info-address {
    position: absolute;
    display: inline-block;
    line-height: normal;
    top: 2.2rem;
  ...
  .datas-wrap > .coupon-wrap > .coupon-items-wrap > .coupon-item > .info > .btn-get {
    position: absolute;
    display: inline-block;
    line-height: normal;
    top: 1.3rem;
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .upkeep-title-min {
    position: relative;
    display: block;
    color: #F95A45;
    font-size: 1.1rem;
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .upkeep-title-detail {
    position: relative;
    display: block;
    color: #F95A45;
    font-size: 0.8rem;
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .upkeep-content {
    position: relative;
    display: block;
    width: 60%;
    color: rgb(73, 73, 73);
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .upkeep-content-img {
    position: relative;
    display: block;
    width: 50%;
    height: 4rem;
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .price-btn-get > span:nth-of-type(1) {
    position: relative;
    display: block;
    text-align: left;
    font-size: 0.6rem;
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .price-btn-get > span:nth-of-type(2) {
    position: relative;
    display: block;
    text-align: left;
    font-size: 1.2rem;
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .price-btn-get > span:nth-of-type(3) {
    position: absolute;
    display: inline-block;
    bottom: 0.7rem;
    right: 0.6rem;
  ...
  .datas-wrap > .upkeep-wrap > .upkeep-item > .upkeep-data-wrap > .upkeep-big-img {
    position: absolute;
    display: block;
